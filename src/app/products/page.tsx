...
const PRODUCTS = [
    ...
    { name: "Nescafe Classic 100g", category: "Grocery", price: "₹175", unit: "100 g", img: "/p-coffee.jpg", desc: "Instant coffee with signature bold flavour.", moq: "30 jars" },
    { name: "Philips LED Bulb 9W", category: "Electronics", price: "₹75", unit: "1 pc", img: "/p-led-bulb.jpg", desc: "Energy-efficient LED bulb with 2-year warranty.", moq: "100 pcs" },
    { name: "Boat Airdopes 141", category: "Electronics", price: "₹999", unit: "1 pc", img: "/p-earbuds.jpg", desc: "Wireless earbuds with 42H playback and IPX4 rating.", moq: "20 pcs" },
    { name: "Classmate Notebook 240p", category: "Office", price: "₹55", unit: "1 pc", img: "/p-notebook.jpg", desc: "Premium quality notebook with 240 pages for daily use.", moq: "100 pcs" },
    { name: "Natraj Pencil Box 10pc", category: "Office", price: "₹45", unit: "1 set", img: "/p-pencil-box.jpg", desc: "Complete pencil set with sharpener and eraser.", moq: "50 sets" },
    { name: "Dettol Antiseptic 750ml", category: "Household", price: "₹199", unit: "750 ml", img: "/p-antiseptic.jpg", desc: "Trusted antiseptic liquid for first aid and hygiene.", moq: "24 pcs" },
    { name: "Pampers Diapers M34", category: "Baby & Pet", price: "₹599", unit: "34 pcs", img: "/p-diapers.jpg", desc: "Premium baby diapers with 12-hour dryness protection.", moq: "10 packs" },
    { name: "Drools Dog Food 3kg", category: "Baby & Pet", price: "₹450", unit: "3 kg", img: "/p-dog-food.jpg", desc: "Complete nutrition dog food with real chicken.", moq: "20 bags" },
    { name: "Prestige Cooker 5L", category: "Home & Kitchen", price: "₹1,350", unit: "1 pc", img: "/p-cooker.jpg", desc: "Aluminium pressure cooker with safety valve and gasket.", moq: "10 pcs" },
    { name: "Bajaj Mixer Grinder 750W", category: "Home & Kitchen", price: "₹2,199", unit: "1 pc", img: "/p-mixer-grinder.jpg", desc: "Powerful mixer grinder with 3 stainless steel jars.", moq: "5 pcs" },
    { name: "Stanley Tool Kit 45pc", category: "Industrial", price: "₹1,899", unit: "1 set", img: "/p-tool-kit.jpg", desc: "Professional grade tool kit with carry case.", moq: "10 sets" },
    { name: "Fevicol MR 500ml", category: "Industrial", price: "₹65", unit: "500 ml", img: "/p-adhesive.jpg", desc: "General purpose adhesive for wood, paper and fabric.", moq: "50 pcs" },
];
